...
async def start_handler(c: Client, m: Message):
    await m.reply_text(
        "Hi, I just create telegram sticker from the text messages you send me.Developed 👨‍💻 With Love By @Mrvasuz❤. "
        "[Movies Group](https://t.me/exploremoviezgroup) on Which Purpose he created me. "
        ".",
...
async def help_handler(c: Client, m: Message):
    await m.reply_text(
        ...
        "\nMy creator @Mrvasuz 💃 "
        "[Moviesgroup](https://t.me/exploremoviezgroup) on how he created me. Jion Group For Latest Movies 👨‍💻"
        ".",
        disable_web_page_preview=True
    )
